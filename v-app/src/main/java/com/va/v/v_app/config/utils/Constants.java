...
final String jwt_secret = "javainuse";
	...
	final String serviceIdHeader = "serviceId";
	final String serviceSeqIdHeader = "serviceSeqId";
	final String accountIdHeader = "accountId";
	final String accountSeqIdHeader = "accountSeqId";
	final String profileIdHeader = "profileId";
	final String profileSeqIdHeader = "profileSeqId";
	final String profileCategoryHeader = "category";
    ...
    final String orderIdHeader = "orderId";
    final String functionIdHeader = "functionIds";
    final String SOURCE_CRM_VALUE = "CRM";
    final String SOURCE_SLM_VALUE = "SLM";
    final String subscriberLevelHeader = "subscriberLevel";
